...
ReportUser.create = function (newusers, result) {
...
ReportUser.findById = function (id, result) {
...
ReportUser.findAll = function (result) {
...
ReportUser.update = function (id, users, result) {
  dbConn.query(
...
ReportUser.delete = function (id, result) {
